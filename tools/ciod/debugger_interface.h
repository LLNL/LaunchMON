...
/*
 * This header is re-generated from CioDebuggerProtocol.h 
 * which is open-sourced for BGP. When we port LaunchMON to
 * BGP, full definition from CioDebuggerProtocol.h should
 * be used. As is, this header only support BGL. 
 */
