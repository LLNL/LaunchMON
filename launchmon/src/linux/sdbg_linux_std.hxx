...
const char * const LAUNCH_BREAKPOINT        = GLUESYM "MPIR_Breakpoint";
...
const char * const LOADER_BP_SYM            = GLUESYM "_dl_debug_state";
const char * const LOADER_R_DEBUG           = "_r_debug";
const char * const LOADER_START             = GLUESYM "_start";
const char * const NPTL_CREATE_SYM          = GLUESYM "__nptl_create_event";
const char * const NPTL_DEATH_SYM           = GLUESYM "__nptl_death_event";
const char * const FORK_SYM                 = GLUESYM "__fork";
const char * const VFORK_SYM                = GLUESYM "__vfork";
...
const char * const LOADER_IDEN              = "/lib/ld-linux.so.2";
# ifdef NPTL_UNDER_TLS                                                                  
const char * const STANDARD_LIBLOC          = "/lib/tls";
# else
const char * const STANDARD_LIBLOC          = "/lib";
# endif
...
typedef struct user_regs_struct               T_GRS;
typedef struct user_fpregs_struct             T_FRS;
const char * const LOADER_IDEN              =  "/lib64/ld-linux.so.2";
# ifdef NPTL_UNDER_TLS                                                                  
const char * const STANDARD_LIBLOC          = "/lib64/tls";          
# else
const char * const STANDARD_LIBLOC          = "/lib64";          
# endif
...
const char * const LOADER_IDEN              = "/lib64/ld.so.1";
# ifdef NPTL_UNDER_TLS
const char * const STANDARD_LIBLOC          = "/lib64/tls";
# else
const char * const STANDARD_LIBLOC          = "/lib64";          
...
typedef struct pt_regs                        T_GRS;
typedef struct pt_regs                        T_FRS;
const char * const LOADER_IDEN              = "/lib/ld.so.1";
# ifdef NPTL_UNDER_TLS
const char * const STANDARD_LIBLOC          = "/lib/tls";
# else
const char * const STANDARD_LIBLOC          = "/lib";          
